...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['action']) && $_POST['action'] == 'update_profile') {
        ...
        if (!empty($nombre)) {
            $update_query = "UPDATE usuarios SET nombre = ?, telefono = ? WHERE id = ?";
            $update_stmt = $db->prepare($update_query);
            
            if ($update_stmt->execute([$nombre, $telefono, $_SESSION['user_id']])) {
...
// Actualizar datos del usuario después de posibles cambios
$user_stmt->execute([$_SESSION['user_id']]);
$user = $user_stmt->fetch(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Configuración - Massola Business</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="settings.php" class="active"><i class="fas fa-cog"></i> Configuración</a></li>
        ...
        <div class="main-content">
            ...
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-user"></i> Información de la Cuenta</h2>
                </div>
                <div class="card-body">
                    <div class="user-details">
                        ...
                        <div class="info-item">
                            ...
                            <span><?php echo ucfirst($user['plan']); ?> (Límite: <?php echo $user['max_productos']; ?> productos)</span>
                        </div>
                        <div class="info-item">
            ...
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-edit"></i> Actualizar Perfil</h2>
                </div>
                <div class="card-body">
